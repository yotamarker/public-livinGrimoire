...
public class Fusion {
    ...
    private String emot = "";
    private LGFIFO<Algorithm> algQueue = new LGFIFO<Algorithm>();
    private LGFIFO<Algorithm> dangerAlgQueue = new LGFIFO<Algorithm>();
    ...
    private void updateRepresentations() {
        ...
        for (Algorithm algorithm : this.algQueue.getElements()) {
