...
public class DRulesAccel extends AbsCmdReq implements Neuronable {
	...
	public DRulesAccel(APSleepAccel apSleepAccel, ChobitAccel.InnerClass actualSleep) {
		super();
		this.apSleep = apSleepAccel;
		int sleepTime = apSleepAccel.getWakeTime() - 2;
		if (sleepTime > 24) {
			sleepTime -= 24;
		}
	...
	public void output(Neuron noiron) {
		...
		case "sleep":
			...
			APSleep0Accel apSleep0 = new APSleep0Accel(actualSleep);
