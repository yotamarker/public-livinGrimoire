...
class TimeUtils {
    ...
    fun translateMonthDay(day1: Int): String {
        var dday = ""
        when (day1) {
            1 -> dday = "first_of"
            2 -> dday = "second_of"
    ...
    fun smallToBig(vararg a: Int): Boolean // return true if input nums decend in value
    {
