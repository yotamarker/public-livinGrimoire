...
class GrimoireMemento(private val absDictionaryDB: AbsDictionaryDB) {
    ...
    private val APNumToObjDic = Hashtable<String, AbsAlgPart?>()
    fun load(obj: AbsAlgPart): AbsAlgPart {
        /*
    ...
    private fun loadMutations(obj: AbsAlgPart, objName: String, objRoot: String) {
