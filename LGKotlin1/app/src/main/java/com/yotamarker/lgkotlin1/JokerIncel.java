...
public class JokerIncel extends Joker {
	...
	public JokerIncel() {
		...
		temp.add("stoned");
		temp.add("shot");
		temp.add("decapitated");
		temp.add("defenestrated");
		...
		temp.clear();
		// friskyvixen list
		temp.add("KinkyVixen7290");
		temp.add("FriskyVixenPants023");
		temp.add("KnotInsideMe1101");
		temp.add("SexyZ00Princess");
		temp.add("WildGrrrrl450");
		temp.add("Beast13Barb13");
		temp.add("BeastialBitch69");
		temp.add("Zoophie420");
